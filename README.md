...
## 3. Telegram Webhook Requires HTTPS
...
Telegram servers cannot access local machines directly.
...
ngrok creates a secure public HTTPS URL that forwards requests to the local FastAPI server.
...
Then configure the Telegram webhook with the generated HTTPS URL.

---

## 4. ngrok Agent Version

### Challenge

Older ngrok versions could not establish tunnels.
...
Installed the latest ngrok version.
...
Created a free ngrok account and configured the authentication token.
